...
\bigskip
\\
\texttt{echo "deb http://deb.debian.org/debian/ bullseye main contrib \textbackslash\\
    non-free"\ {\textgreater}{\textgreater} /etc/apt/sources.list}
\\
\texttt{echo "deb-src http://deb.debian.org/debian/ bullseye main contrib \textbackslash\\
    non-free"\ {\textgreater}{\textgreater} /etc/apt/sources.list}
\\
\texttt{echo "deb https://efalive.hannay.de/debian/ bullseye main" \textbackslash\\
