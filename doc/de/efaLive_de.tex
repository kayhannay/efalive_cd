...
\textbf{ACHTUNG:} Das ISO Abbild ist mittlerweile zu groß für eine normale CD, 
daher müssen entweder übergroße CD Rohlinge oder DVD Rohlinge verwendet 
werden.
...
\begin{figure}
    \centering
    \includegraphics[width=8cm]{efaLivede-img/efalive_setup.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/select_language.png}
...
\begin{minipage}{\linewidth}
  \centering
  \includegraphics[width=10cm]{efaLivede-img/select_network_card.png}
...
\begin{minipage}{\linewidth}
  \centering
  \includegraphics[width=10cm]{efaLivede-img/message_no_network.png}
...
\begin{minipage}{\textwidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/message_dhcp_failed.png}
...
\begin{minipage}{\textwidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/select_network_manually.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/select_timezone.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/select_partitioning.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/select_drive.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/accept_partitioning.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/confirm_partitioning.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/use_mirror.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/select_mirror_country.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/select_mirror.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/set_mirror_proxy.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/select_bootloader_mbr.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLivede-img/finish_installation.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=12cm]{efaLivede-img/network_manager.png}
...
\begin{figure}
    \centering
    \includegraphics[width=13cm]{efaLivede-img/network_manager_wifi.png}
