...
Ein RaspberryPi kann mit einem Schalter ein- und ausgeschaltet werden. Für das Ausschalten reicht es ggf. efa
zu beenden. Zum Einschalten muss ein Schalter genutzt werden. Dies sollte ein Taster sein, der beim Drücken Pin
5 (GPIO3) und 6 (GND) des RaspberryPi kurzschließt. Um diese Funktionalität freizuschalten, sollte als Benutzer
"`root"' die folgende Zeile in der Datei \texttt{/boot/config.txt} aktiviert werden (\# entfernen):
\bigskip
\\
