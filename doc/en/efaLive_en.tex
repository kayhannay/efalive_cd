...
\textbf{ATTENTION:} The ISO image has grown so that it does not fit on 
a normal CD blank. You have to use an oversize CD oder a DVD.
...
\begin{figure}
    \centering
    \includegraphics[width=8cm]{efaLiveen-img/efalive_setup.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/select_language.png}
...
\begin{minipage}{\linewidth}
  \centering
  \includegraphics[width=10cm]{efaLiveen-img/select_network_card.png}
...
\begin{minipage}{\linewidth}
  \centering
  \includegraphics[width=10cm]{efaLiveen-img/message_no_network.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/message_dhcp_failed.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/select_network_manually.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/select_timezone.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/select_partitioning.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/select_drive.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/accept_partitioning.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/confirm_partitioning.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/use_mirror.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/select_mirror_country.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/select_mirror.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/set_mirror_proxy.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/select_bootloader_mbr.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=10cm]{efaLiveen-img/finish_installation.png}
...
\begin{minipage}{\linewidth}
    \centering
    \includegraphics[width=12cm]{efaLiveen-img/network_manager.png}
...
\begin{figure}
    \centering
    \includegraphics[width=13cm]{efaLiveen-img/network_manager_wifi.png}
