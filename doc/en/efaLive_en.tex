...
more about this in chapter 7.1.
...
\texttt{{\textless}Ctrl{\textgreater}+{\textless}Alt{\textgreater}+{\textless}F1{\textgreater}}
to
...
dialog instead. This is done in efaLive-Setup (chapter 5).
...
Here you can't use the instructions mentioned in 6.2.4.
...
log in as user "root" (4.1). Change the
...
this case. It can be used in the same way as described in 8.2.1.
